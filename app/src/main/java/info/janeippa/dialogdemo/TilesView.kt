...
import info.janeippa.dialogdemo.databinding.TileItemCellBinding
import info.janeippa.dialogdemo.databinding.TileSectionCellBinding
...
class TilesView: RecyclerView {
    ...
    class Adapter(private val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun getItemViewType(position: Int): Int =
            if (items[position].isSection) VIEW_TYPE_SECTION else VIEW_TYPE_ITEM

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
            if (viewType == VIEW_TYPE_SECTION)
                SectionViewHolder(TileSectionCellBinding.inflate(LayoutInflater.from(context), parent, false))
            else
